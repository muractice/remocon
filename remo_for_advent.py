...
res = executeSignalApi('496ec97f-c627-4cba-be68-444cb3751789',headers=headers)
if (res.status_code != 200):
    sys.exit("boot error")

time.sleep(10)
channel = sys.argv[1]
res = executeSignalApi(signalChannel[int(channel)],headers=headers)
if (res.status_code != 200):
    sys.exit("change channel error")

time.sleep(3)
res = executeSignalApi('19c641cb-fec8-4b94-b3f2-dc3013f88584',headers=headers)
if (res.status_code != 200):
    sys.exit("recoding error")

time.sleep(1)
res = executeSignalApi('90efd112-44b6-4da6-b123-e71cde96838a',headers=headers)
if (res.status_code != 200):
